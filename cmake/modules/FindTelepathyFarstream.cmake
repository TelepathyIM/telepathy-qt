...
if (NOT WIN32)
    ...
    if (TELEPATHY_FARSTREAM_MIN_VERSION)
        PKG_CHECK_MODULES(PC_TELEPATHY_FARSTREAM telepathy-farstream-1>=${TELEPATHY_FARSTREAM_MIN_VERSION})
    else (TELEPATHY_FARSTREAM_MIN_VERSION)
        PKG_CHECK_MODULES(PC_TELEPATHY_FARSTREAM telepathy-farstream-1)
...
find_library(TELEPATHY_FARSTREAM_LIBRARIES NAMES telepathy-farstream-1
   PATHS
