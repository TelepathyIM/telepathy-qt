 ...
 *             contact.
 */
ContactCapabilities::ContactCapabilities(const TpDBus::RequestableChannelClassList &rccs,
 ...
 *
 * \param rccSpecs TpDBus::RequestableChannelClassList representing the capabilities of a
 *                 contact.
 */
