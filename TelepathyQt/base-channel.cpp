...
struct TP_QT_NO_EXPORT BaseChannelMessageArchiveInterface::Private {
    Private(BaseChannelMessageArchiveInterface *parent,
            const QStringList &availableFilterKeys)
        : availableFilterKeys(availableFilterKeys),
          adaptee(new BaseChannelMessageArchiveInterface::Adaptee(parent))
    {
    }

    QStringList availableFilterKeys;
...
QStringList BaseChannelMessageArchiveInterface::Adaptee::availableFilterKeys() const
{
    return mInterface->availableFilterKeys();
}
 ...
 * Class constructor.
 */
BaseChannelMessageArchiveInterface::BaseChannelMessageArchiveInterface(const QStringList &availableFilterKeys)
    : AbstractChannelInterface(TP_QT_IFACE_CHANNEL_INTERFACE_MESSAGE_ARCHIVE),
      mPriv(new Private(this, availableFilterKeys))
{
}
...
{
    QVariantMap map;
    map.insert(TP_QT_IFACE_CHANNEL_INTERFACE_MESSAGE_ARCHIVE + QLatin1String(".AvailableFilterKeys"),
               QVariant::fromValue(availableFilterKeys()));
    return map;
}

QStringList BaseChannelMessageArchiveInterface::availableFilterKeys() const
{
    return mPriv->availableFilterKeys;
}
